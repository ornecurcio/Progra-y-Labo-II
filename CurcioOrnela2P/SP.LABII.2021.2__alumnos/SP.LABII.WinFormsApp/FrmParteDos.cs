...
namespace SP.LABII.WinFormsApp
{
    ...
    public partial class FrmParteDos : Form
    {
        ...
        public void CargarListadoProductosBD()
        {
            ...
            ///
            this.lista = Entidades.AccesoDatos.ObtenerTodos();
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                Entidades.AccesoDatos ado = new Entidades.AccesoDatos();

                ///Asociar 'dinámicamente' el manejador de eventos (Manejador_marcaExistente) aquí 
                ado.MarcaExistente += Manejador_marcaExistente; 
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            Entidades.Producto prod = this.lista[i];
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                Entidades.AccesoDatos ado = new Entidades.AccesoDatos();
                if (ado.Eliminar(frm.MiProducto.Codigo))
                {
        ...
        private void Manejador_marcaExistente(object sender, EventArgs e)
        {
            ...
            ///
            List<Entidades.Producto> lista = (List<Producto>)sender; ///reemplazar por lo que corresponda
