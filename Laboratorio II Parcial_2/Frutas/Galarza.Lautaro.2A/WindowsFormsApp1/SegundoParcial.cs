...
namespace SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        {
            MessageBox.Show("Galarza Lautaro");
        }
        ...
        private void btnPunto5_Click(object sender, EventArgs e)
        {
            ...
            this.c_bananas.eventoPrecio += new Cajon<Banana>.PrecioExcedidoDel(manejadora.LimitePrecio);
        ...
        private static string ObtenerListadoFrutas()
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConexion = new SqlConnection(Properties.Settings.Default.conexion))
                {
                    ...
                    comando.CommandText = " SELECT * FROM frutas";//codigo del sql management 
                    SqlDataReader dataReader = comando.ExecuteReader();

                    while (dataReader.Read() != false)
                    {
                        cadena += "ID: " + dataReader["id"].ToString() + " Nombre: " + dataReader["nombre"].ToString() + " Peso: " + dataReader["peso"].ToString() + " Precio: " + dataReader["precio"].ToString() + "\n";
                    }
